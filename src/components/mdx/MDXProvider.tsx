...
const components = {
	...
	h1: (props: ComponentPropsWithoutRef<'h1'>) => (
		<h1
			className="font-sketch text-4xl font-bold tracking-tight text-[var(--color-chalk)] mb-6"
			{...props}
		/>
	),
	h2: ({ children, ...rest }: ComponentPropsWithoutRef<'h2'>) => (
		<h2
			className="font-sketch text-2xl font-bold tracking-tight text-[var(--color-chalk)] mt-16 mb-4 relative inline-block"
			{...rest}
		>
			{children}
			<svg
	...
	h3: (props: ComponentPropsWithoutRef<'h3'>) => (
		<h3
			className="font-sketch text-xl font-semibold text-[var(--color-chalk-dim)] mt-8 mb-3 italic"
			{...props}
		/>
	),
