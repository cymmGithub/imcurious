...
HTTP methods are promises you make about your endpoint's behavior, and the infrastructure of the web assumes you keep those promises. Safety and idempotency aren't properties HTTP gives you for free on GET; they're properties you guarantee by how you write the handler. Break the contract and you can certainly do it — but you've made your endpoint un-cacheable, un-retryable, and dangerous in the face of the very behaviors the contract was designed to enable safely.
